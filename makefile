...
make_tp1: main.o calcular_error.o cmdline.o complejo.o transformadas.o leer_cmdline.o
	$(CC) $(CFLAGS) -o tp1 main.o calcular_error.o cmdline.o complejo.o transformadas.o leer_cmdline.o

main_casos_prueba.o: main.cpp complejo.h array.h transformadas.h leer_cmdline.h calcular_error.h
...
transformadas.o: transformadas.cpp transformadas.h 
	$(CC) $(CFLAGS) -o transformadas.o -c transformadas.cpp
